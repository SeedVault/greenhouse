<template>
  <div>
    ...
    <div class="list" v-show="!fetching">
      <div class="row">
        <div class="col-6">
          <a @click="setStatus('')" v-bind:class="{'list__filter': true, 'active': status === '' }" href="#">{{ $t('domain.component_statuses.all') }}</a>
          <a @click="setStatus('enabled')" v-bind:class="{'list__filter': true, 'active': status === 'enabled' }" href="#">{{ $t('domain.component_statuses.enabled') }}</a>
          <a @click="setStatus('disabled')" v-bind:class="{'list__filter': true, 'active': status === 'disabled' }" href="#">{{ $t('domain.component_statuses.disabled') }}</a>
        </div>
            ...
            <div class="media">
              ...
              <div class="media-body list-body mb-2">
                ...
                <div class="list__misc clearfix">
                  ...
                  <div class="list__category">{{ $t("common.by") }} {{ component.username }}</div>
