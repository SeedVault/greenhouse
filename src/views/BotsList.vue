  ...
  <div>
    ...
    <div class="list" v-show="!fetching">
      <div class="row">
        <div class="col-6">
          <a @click="setStatus('')"
          v-bind:class="{'list__filter': true, 'active': status === '' }"
          href="#">{{ $t('domain.bot_statuses.all') }}</a>
          <a @click="setStatus('enabled')"
          v-bind:class="{'list__filter': true, 'active': status === 'enabled' }"
          href="#">{{ $t('domain.bot_statuses.enabled') }}</a>
          <a @click="setStatus('disabled')"
          v-bind:class="{'list__filter': true, 'active': status === 'disabled' }"
          href="#">{{ $t('domain.bot_statuses.disabled') }}</a>
        </div>
