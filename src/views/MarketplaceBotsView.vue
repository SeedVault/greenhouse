  ...
  <div>
    ...
    <div class="row row-form view" v-show="!deleting && !deleted">
      ...
      <div class="col-md-7">
        ...
        <div class="col-md-2">
          <button type="submit" class="btn btn-sm btn-primary btn-block mb-2" @click="editBot()">{{ $t('bots.configure') }}</button>
          <button type="submit" class="btn btn-sm btn-danger btn-block mb-2" @click="confirmUnsubscribe()">{{ $t('bots.unsubscribe') }}</button>
        </div>
      </div>
      <div class="row view">
        <div class="col-md-3">
